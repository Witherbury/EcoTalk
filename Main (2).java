        ...
        while(true)
        {
          ...
          while(true)
          {
           ...
           if (inp.equalsIgnoreCase("flip a coin"))
           {
            ...
            if (inp.equalsIgnoreCase("What is your favorite colour") ||(inp.equalsIgnoreCase ("What are your favorite colours")))
            {
               
                System.out.println("My favorite colours are those of Mother Nature , BLUE and GREEN");
